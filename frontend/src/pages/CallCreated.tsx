            ...
            <div className="w-full flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center justify-center gap-2 w-full h-[50px] rounded-xl border border-zinc-700 bg-zinc-900/60 text-white text-[13px] hover:bg-zinc-800 active:scale-[0.98] transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
